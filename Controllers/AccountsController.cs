...
namespace e_commmerce.Controllers
{
    public class AccountsController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("Uid,User,Pass,FirstName,LastName,IsAdmin")] Account account)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Uid,IsAdmin")] Account account)
        {
            if (id != account.Uid)
            {
                return NotFound();
